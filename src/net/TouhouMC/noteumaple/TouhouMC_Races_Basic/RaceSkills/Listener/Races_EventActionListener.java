...
import net.TouhouMC.noteumaple.TouhouMC_Races_Basic.RaceSkills.Listener.Listened_Skills.Races_KAM;
...
public class Races_EventActionListener implements Listener {
	...
	public void onAsyncChat(AsyncPlayerChatEvent e){
		...
		if (conf.contains("user." + pl.getUniqueId())){
			...
			if (realrace == null ) realrace = conf.getString("user." + pl.getUniqueId() + ".race");
			NametagAPI.setNametagHard(pl.getPlayerListName(), realrace, "");
			e.setFormat(ChatColor.WHITE + "[" + realrace + ChatColor.WHITE + "]" + format);
		}
	}
	...
	public void onPlayerInteract(final PlayerInteractEvent e){
		...
		int mana = 0;
				...
				if (race.equalsIgnoreCase("tukibito")) {
					if(handitem == Material.WATCH && (pl.isSneaking())){
						if(Races_Global.magic_iscastable(pl , mana,"発動！！")){
							...
							conf.set("user." + pl.getUniqueId() + ".spilit", conf.getDouble("user." + pl.getUniqueId() + ".spilit") - mana);
							TouhouMC_Races_Basic.SaveTMCConfig();
							pl.getWorld().playSound(pl.getLocation(), Sound.ANVIL_USE, 1, 0);
							pl.sendMessage(pluginpre + ChatColor.GREEN + "霊力" + ChatColor.LIGHT_PURPLE + conf.getDouble(new StringBuilder("user.").append(pl.getUniqueId()).append(".spilit").toString()));
							TouhouMC_Races_Basic.plugin0.getServer().getScheduler().scheduleSyncDelayedTask(TouhouMC_Races_Basic.plugin0, new Runnable() {
								public void run() {
				...
				if (race.equalsIgnoreCase("sukimayou"))
				{
					...
					if(handitem == Material.DIAMOND_AXE && (pl.isSneaking())){
						if(Races_Global.magic_iscastable(pl , mana,"スキマを呼び出している！")){
							...
							conf.set("user." + pl.getUniqueId() + ".spilit", conf.getDouble("user." + pl.getUniqueId() + ".spilit") - mana);
							TouhouMC_Races_Basic.SaveTMCConfig();
							pl.getWorld().playSound(pl.getLocation(), Sound.ZOMBIE_INFECT, 1.0F, 1.0F);
							pl.getWorld().playEffect(pl.getLocation(), Effect.FOOTSTEP, 3, 3);
							pl.sendMessage(pluginpre + ChatColor.GREEN + "霊力" + ChatColor.LIGHT_PURPLE + conf.getDouble(new StringBuilder("user.").append(pl.getUniqueId()).append(".spilit").toString()));
							TouhouMC_Races_Basic.plugin0.getServer().getScheduler().scheduleSyncDelayedTask(TouhouMC_Races_Basic.plugin0, new Runnable(){
								public void run(){
				...
				if (race.equalsIgnoreCase("kairikirannsin") ) {
					if(handitem == Material.GOLD_PICKAXE && (pl.isSneaking())){
						if(Races_Global.magic_iscastable(pl , mana,"片足を構えた！")){
							...
							conf.set("user." + pl.getUniqueId() + ".spilit", conf.getDouble("user." + pl.getUniqueId() + ".spilit") - mana);
							TouhouMC_Races_Basic.SaveTMCConfig();
							pl.getWorld().playSound(pl.getLocation(), Sound.IRONGOLEM_WALK, 1, 0);
							pl.sendMessage(pluginpre + ChatColor.GREEN + "霊力" + ChatColor.LIGHT_PURPLE + conf.getDouble(new StringBuilder("user.").append(pl.getUniqueId()).append(".spilit").toString()));
							TouhouMC_Races_Basic.plugin0.getServer().getScheduler().scheduleSyncDelayedTask(TouhouMC_Races_Basic.plugin0, new Runnable() {
								public void run() {
				...
				if (race.equalsIgnoreCase("sinnzyuu") ) {
					if(handitem == Material.SHEARS && (pl.isSneaking())){
						if(Races_Global.magic_iscastable(pl , mana,"息を整え")){
							...
							conf.set("user." + pl.getUniqueId() + ".spilit", conf.getDouble("user." + pl.getUniqueId() + ".spilit") - mana);
							TouhouMC_Races_Basic.SaveTMCConfig();
							pl.getWorld().playSound(pl.getLocation(), Sound.WOLF_WHINE, 1, 0);
							pl.sendMessage(pluginpre + ChatColor.GREEN + "霊力" + ChatColor.LIGHT_PURPLE + conf.getDouble(new StringBuilder("user.").append(pl.getUniqueId()).append(".spilit").toString()));
							TouhouMC_Races_Basic.plugin0.getServer().getScheduler().scheduleSyncDelayedTask(TouhouMC_Races_Basic.plugin0, new Runnable() {
								public void run() {
			...
			if (e.getAction() == Action.LEFT_CLICK_AIR || e.getAction() == Action.LEFT_CLICK_BLOCK) {
				...
				if (race.equalsIgnoreCase("ryuugyo") ) {
					if(handitem == Material.FLINT_AND_STEEL && (pl.isSneaking())){
						if(Races_Global.magic_iscastable(pl , mana,"ポーズを構えた！")){
							...
							conf.set("user." + pl.getUniqueId() + ".spilit", conf.getDouble("user." + pl.getUniqueId() + ".spilit") - mana);
							TouhouMC_Races_Basic.SaveTMCConfig();
							pl.getWorld().playSound(pl.getLocation(), Sound.ITEM_PICKUP, 1, 1);
							pl.sendMessage(pluginpre + ChatColor.GREEN + "霊力" + ChatColor.LIGHT_PURPLE + conf.getDouble(new StringBuilder("user.").append(pl.getUniqueId()).append(".spilit").toString()));
							TouhouMC_Races_Basic.plugin0.getServer().getScheduler().scheduleSyncDelayedTask(TouhouMC_Races_Basic.plugin0, new Runnable() {
								public void run() {
				...
				//仙人の壁抜
				mana = 15;
				if (handitem == Material.FLINT_AND_STEEL && race.equalsIgnoreCase("sennnin") || race.equalsIgnoreCase("kodaizin")) {
					if ((pl.isSneaking())) {
						if(Races_Global.magic_iscastable(pl , mana,"打ち金を構えた！")){
							MetadataValue casting = new FixedMetadataValue(TouhouMC_Races_Basic.plugin0, Boolean.valueOf(true));
							pl.setMetadata("casting", casting);
							conf.set("user." + pl.getUniqueId() + ".spilit", conf.getDouble("user." + pl.getUniqueId() + ".spilit") - mana);
							TouhouMC_Races_Basic.SaveTMCConfig();
							pl.getWorld().playSound(pl.getLocation(), Sound.STEP_SAND, 1, 0);
							pl.sendMessage(pluginpre + ChatColor.GREEN + "霊力" + ChatColor.LIGHT_PURPLE + conf.getDouble(new StringBuilder("user.").append(pl.getUniqueId()).append(".spilit").toString()));
							TouhouMC_Races_Basic.plugin0.getServer().getScheduler().scheduleSyncDelayedTask(TouhouMC_Races_Basic.plugin0, new Runnable()
							{
								public void run() 
	...
	public void onPlayerInteractEntity(final PlayerInteractEntityEvent e){
			...
			if (race.equalsIgnoreCase("oni") || race.equalsIgnoreCase("kairikirannsin")){
				if(handitem == Material.IRON_PICKAXE && e.getRightClicked() instanceof LivingEntity && (pl.isSneaking())){
					...
					{
						if (Races_Global.No_Team_Friendly_Fire(TouhouMC_Races_Basic.plugin0, pl, (Player)e.getRightClicked()))
						{
							no_damage = true;
						}
					}
					...
					if(Races_Global.magic_iscastable(pl , mana,"拳を構えた！")){
						...
						conf.set("user." + pl.getUniqueId() + ".spilit", conf.getDouble("user." + pl.getUniqueId() + ".spilit") - mana);
						TouhouMC_Races_Basic.SaveTMCConfig();
						pl.getWorld().playSound(pl.getLocation(), Sound.ANVIL_LAND, 1, 3);
						pl.sendMessage(pluginpre + ChatColor.GREEN + "霊力" + ChatColor.LIGHT_PURPLE + conf.getDouble(new StringBuilder("user.").append(pl.getUniqueId()).append(".spilit").toString()));
						TouhouMC_Races_Basic.plugin0.getServer().getScheduler().scheduleSyncDelayedTask(TouhouMC_Races_Basic.plugin0, new Runnable() {
							public void run() {
			...
			if (race.equalsIgnoreCase("kyuuketuki") || race.equalsIgnoreCase("kinnima")){
				if(handitem == Material.IRON_PICKAXE && e.getRightClicked() instanceof LivingEntity && (pl.isSneaking())){
					...
					if(Races_Global.magic_iscastable(pl , mana,"牙を構えた！")){
						...
						conf.set("user." + pl.getUniqueId() + ".spilit", conf.getDouble("user." + pl.getUniqueId() + ".spilit") - mana);
						TouhouMC_Races_Basic.SaveTMCConfig();
						pl.getWorld().playSound(pl.getLocation(), Sound.SPIDER_IDLE, 1, 1);
						pl.sendMessage(pluginpre + ChatColor.GREEN + "霊力" + ChatColor.LIGHT_PURPLE + conf.getDouble(new StringBuilder("user.").append(pl.getUniqueId()).append(".spilit").toString()));
						TouhouMC_Races_Basic.plugin0.getServer().getScheduler().scheduleSyncDelayedTask(TouhouMC_Races_Basic.plugin0, new Runnable() {
							public void run() {
			...
			if (race.equalsIgnoreCase("kinnima")){
				if(handitem == Material.DIAMOND_PICKAXE && e.getRightClicked() instanceof LivingEntity && (pl.isSneaking())){
					...
					if(Races_Global.magic_iscastable(pl , mana,"手の平を構えた！")){
						...
						conf.set("user." + pl.getUniqueId() + ".spilit", conf.getDouble("user." + pl.getUniqueId() + ".spilit") - mana);
						TouhouMC_Races_Basic.SaveTMCConfig();
						pl.getWorld().playSound(pl.getLocation(), Sound.NOTE_PLING, 1, 2);
						pl.sendMessage(pluginpre + ChatColor.GREEN + "霊力" + ChatColor.LIGHT_PURPLE + conf.getDouble(new StringBuilder("user.").append(pl.getUniqueId()).append(".spilit").toString()));
						TouhouMC_Races_Basic.plugin0.getServer().getScheduler().scheduleSyncDelayedTask(TouhouMC_Races_Basic.plugin0, new Runnable() {
							public void run() {
	...
	@EventHandler
	public static void EntityDamageByEntity(EntityDamageByEntityEvent event) {
		int mana = 30;
		if (event.getDamager() instanceof Player ) {
			...
			String race = conf.getString("user." + pl.getUniqueId() + ".race").toString();
			//死人
			if (race.equalsIgnoreCase("sibito") || race.equalsIgnoreCase("ennma")&& conf.getInt("user." + pl.getUniqueId() + ".spilit") >= mana)
				Races_NNG.sibito_deadattack(pl, TouhouMC_Races_Basic.plugin0, event);
			//TODO 閻魔
			if (race.equalsIgnoreCase("ennma") && conf.getInt("user." + pl.getUniqueId() + ".spilit") >= mana)
				Races_NNG.ennma_judgementattack(pl, TouhouMC_Races_Basic.plugin0, event);
			//現人神
			if (race.equalsIgnoreCase("gennzinnsin") || race.equalsIgnoreCase("seizin") && conf.getInt("user." + pl.getUniqueId() + ".spilit") >= mana)
			...
			if (race.equalsIgnoreCase("akuma") || race.equalsIgnoreCase("kyuuketuki") || race.equalsIgnoreCase("kinnima"))
				if (conf.getInt("user." + pl.getUniqueId() + ".spilit") >= mana)
				{
			...
			//TODO 狂霊
			if (race.equalsIgnoreCase("kyourei") && conf.getInt("user." + pl.getUniqueId() + ".spilit") >= mana)
				Races_SIR.kyourei_berserker(pl, TouhouMC_Races_Basic.plugin0, event, boost);
			//TODO 玉兎
			if (race.equalsIgnoreCase("gyokuto") && conf.getInt("user." + pl.getUniqueId() + ".spilit") >= mana)
			...
			//TODO 死神
			if (race.equalsIgnoreCase("sinigami") && conf.getInt("user." + pl.getUniqueId() + ".spilit") >= 50)
		...
		if (event.getEntity() instanceof Player) {
			...
			//TODO 聖人
			if (race.equalsIgnoreCase("seizin") && conf.getInt("user." + pl.getUniqueId() + ".spilit") >= mana)
				Races_NNG.seizin_luckydefence(pl, TouhouMC_Races_Basic.plugin0, event);
			//TODO 天人
			if (race.equalsIgnoreCase("tennzin") && conf.getInt("user." + pl.getUniqueId() + ".spilit") >= mana)
				Races_NNG.tennzin_mazo(pl, TouhouMC_Races_Basic.plugin0, event);
			//TODO 古代人
			if (race.equalsIgnoreCase("kodaizin") && conf.getInt("user." + pl.getUniqueId() + ".spilit") >= mana)
			...
			//小人
			else if (race.equalsIgnoreCase("kobito")&& conf.getInt("user." + pl.getUniqueId() + ".spilit") >= mana) Races_YUS.kobito_glaze(pl, TouhouMC_Races_Basic.plugin0, event);
			//TODO 地獄妖精
			...
			//サトリ
			if (race.equalsIgnoreCase("satori")&& conf.getInt("user." + pl.getUniqueId() + ".spilit") >= 50) Races_YUS.satori_satori(pl, TouhouMC_Races_Basic.plugin0, event);
			//TODO 巨人
			if (race.equalsIgnoreCase("satori")&& conf.getInt("user." + pl.getUniqueId() + ".spilit") >= 50) Races_YUS.satori_satori(pl, TouhouMC_Races_Basic.plugin0, event);
			//TODO 四季妖
			if (race.equalsIgnoreCase("sikiyou")&& conf.getInt("user." + pl.getUniqueId() + ".spilit") >= 50) Races_YUS.sikiyou_rose_venom(pl, TouhouMC_Races_Basic.plugin0, event);
			//TODO 鬼人
			...
			//怨霊
			if (race.equalsIgnoreCase("onnryou")&& conf.getInt("user." + pl.getUniqueId() + ".spilit") >= 20) Races_SIR.onnryou_never_vanish(pl, TouhouMC_Races_Basic.plugin0, event, boost);
			//地縛霊
			if (race.equalsIgnoreCase("zibakurei")&& conf.getInt("user." + pl.getUniqueId() + ".spilit") >= 50) Races_SIR.zibakurei_always_unvanish(pl, TouhouMC_Races_Basic.plugin0, event, boost);
			//神
			if (race.equalsIgnoreCase("kami") || race.equalsIgnoreCase("houzyousin") || race.equalsIgnoreCase("yakusin")|| race.equalsIgnoreCase("tyuuousin") || race.equalsIgnoreCase("dotyakusin") || race.equalsIgnoreCase("tukumogami") || race.equalsIgnoreCase("sinigami"))
				if (conf.getInt("user." + pl.getUniqueId() + ".spilit") >= mana)
				{
			...
			//付喪神
			if (race.equalsIgnoreCase("tukumogami") && conf.getInt("user." + pl.getUniqueId() + ".spilit") >= 0)
	...
	public void onPlayerDamage(EntityDamageEvent e){
		...
		if(ent instanceof Player){
			...
			if (race.equalsIgnoreCase("seirei")||race.equalsIgnoreCase("hannrei")||race.equalsIgnoreCase("sourei")||race.equalsIgnoreCase("onnryou") ||race.equalsIgnoreCase("sinnrei")||race.equalsIgnoreCase("saigyouyou")||race.equalsIgnoreCase("zibakurei")||race.equalsIgnoreCase("kyourei") )
			{
				if (conf.getInt("user." + pl.getUniqueId() + ".spilit") >= mana && (pl.isSneaking())) Races_SIR.seirei_mighty_guard(pl, TouhouMC_Races_Basic.plugin0, e, boost);
			}
			//TODO 西行妖
	...
	//馬の盗難防止
	@EventHandler
	public void no_owner_horse(PlayerInteractEntityEvent event)
	{
		if (event.getRightClicked() instanceof Horse && event.getPlayer() instanceof Player)
		{
			if (event.getRightClicked().hasMetadata("tamedhorse"))
			{
				if (!event.getRightClicked().getMetadata("horseowner").get(0).asString().equalsIgnoreCase(event.getPlayer().getUniqueId().toString()))
				{
					event.getPlayer().sendMessage(TouhouMC_Races_Basic.tmc_Races_pre + ChatColor.GRAY + "馬はあなたが所有者であることを否定した！");
